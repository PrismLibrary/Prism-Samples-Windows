...
namespace AdventureWorks.UILogic
{
    ...
    public interface IValidatableBindableBase : INotifyPropertyChanged
    {
        ...
        /// Gets all errors.
        /// </summary>
        /// <returns> A Dictionary that's key is a property name and the value is a Collection of the error strings.</returns>
        Dictionary<string, Collection<string>> GetAllErrors();
        ...
        void SetAllErrors(IDictionary<string, Collection<string>> entityErrors);
    }
}